export const itemKey = {
	pokeball: {
		...
		description: [
			...
			'Permite a los Pokémon unirse a tu grupo. \nMultiplicador de captura: x1', '可以收服宝可梦加入队伍。\n捕捉倍率：x1'
		],
	...
	potion: {
		...
		description: [
			...
			'Restaura 20PS al Pokémon activo en combate. \nSe rellena en el Centro Pokémon.', '战斗中为出战宝可梦回复20HP。\n在宝可梦中心自动补满。'
		],
	...
	pokeRadar: {
		...
		description: [
			...
			'Permite rastrear a Pokémon salvajes.', '可以追踪野生宝可梦。'
		],
	...
	letterWithoutSender: {
		...
		description: [
			...
			'Cuando todo sea estático, y el zumbido te despierte... 8181.', '当一切静止，嗡鸣声将你唤醒……8181。'
		],
	...
	letterForAmalia: {
		...
		description: [
			...
			'Una carta para Amalia, vive en Pueblo Lavanda.', '给住在紫苑镇的Amalia的一封信。'
		],
	...
	rod: {
		...
		description: [
			...
			'Permite pescar en aguas estancadas.', '可以在静水中钓鱼。'
		],
	...
	expShare: {
		...
		description: [
			...
			'Reparte la experiencia ganada en combate entre todo el grupo.', '将战斗中获得的经验分配给全队。'
		],
	...
	expCharm: {
		...
		description: [
			...
			'Aumenta un 75% la experiencia ganada en combate.', '战斗中获得经验增加75%。'
		],
	...
	catchingCharm: {
		...
		description: [
			...
			'Aumenta la probabilidad de capturar Pokémon.', '提高捕捉宝可梦的几率。'
		],
	...
	shinyCharm: {
		...
		description: [
			...
			'Aumenta la probabilidad de encontrar Pokémon variocolor.', '提高遇到闪光宝可梦的几率。'
		],
	...
	amuletCoin: {
		...
		description: [
			...
			'Aumenta el oro ganado en combate.', '增加战斗中获得的金币。'
		],
	...
	mysticCharm: {
		...
		description: [
			...
			'Aumenta 100% la experiencia y el oro ganado en combate.', '战斗中获得经验和金币翻倍。'
		],
	...
	token: {
		...
		description: [
			...
			'Moneda del Casino canjeable por premios.', '赌场代币，可兑换奖品。'
		],
	...
	runningShoes: {
		...
		description: [
			...
			'Reduce el número de encuentros un 25% en las rutas de paso.', '在道路上减少25%的野生遭遇。'
		],
	...
	potionFiller: {
		...
		description: [
			...
			'Rellena todas las pociones. Se rellena en el Centro Pokémon.', '补满所有伤药。在宝可梦中心自动补满。'
		],
	...
	unionTicket: {
		...
		description: [
			...
			'Ticket intercambiable en la Sala Unión.', '可在联合房间兑换的券。'
		],
	...
	sprinkler: {
		...
		description: [
			...
			'Elimina a los molestos arbustos.', '清除烦人的灌木丛。'
		],
	...
	powerBracelet: {
		...
		description: [
			...
			'Rompe en pedazos los cúmulos de rocas.', '打碎岩石堆。'
		],
	...
	travelVoucher: {
		...
		description: [
			...
			'Permite viajar de forma ilimitada en el S.S. Aqua.', '无限乘坐水流号的船票。'
		],
	...
	bike: {
		...
		name: ['Bike', 'Bici', '自行车'],
		description: [
			'Allows faster travel on routes.',
			'Permite viajar más rápido por las rutas.', '可以在道路上行进得更快。'
		],
	...
	waterBike: {
		...
		description: [
			...
			'Permite atravesar aguas profundas.', '可以穿越深水区域。'
		],
	...
	rareOrb: {
		...
		description: [
			...
			'Un orbe que parece observarte.', '一颗似乎在注视你的宝珠。'
		],
	...
	redButton: {
		...
		description: [
			...
			'Un botón altamente llamativo.', '一个非常显眼的按钮。'
		],
	...
	scrap: {
		...
		description: [
			...
			'Alguien podría darle uso.', '也许有人能用得上它。'
		],
	...
	accessPass: {
		...
		description: [
			...
			'Autoriza el paso hacia la ruta 12.', '可以进入12号道路。'
		],
	...
	fossilDome: {
		...
		description: [
			...
			'Fósil de un antiguo Pokémon. \n Puede ser revivido en el Centro arqueológico de Ciudad Endrino.', '古代宝可梦的化石。\n可以在烟墨市考古中心复活。'
		],
	...
	apricornBlue: {
		...
		description: [
			...
			'Fruto originario de la región de Johto.', '城都地区的特产果实。'
		],
	...
	key1: {
		...
		description: [
			...
			'Abre una casa en la Ruta 43.', '打开43号道路上一间房屋的钥匙。'
		],
	...
	key2: {
		...
		description: [
			...
			'Abre la Central Eléctrica en la Ruta 10.', '打开10号道路发电厂的钥匙。'
		],
	...
	key3: {
		...
		description: [
			...
			'Abre las puertas de un elevador cerca de Ciudad Orquídea.', '打开湛蓝市附近电梯门的钥匙。'
		],
	...
	lithicStone: {
		...
		description: [
			'An uncommon stone.', 
			'Una piedra poco común.', '一块不寻常的石头。'
		],
	...
	honey: {
		...
		description: [
			'Pokémon love it.', 
			'A los Pokémon les encanta.', '宝可梦们都很喜欢。'
		],
	...
	umbrella: {
		...
		description: [
			...
			'Un paraguas de color negro.', '一把黑色的雨伞。'
		],
